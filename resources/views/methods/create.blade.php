                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Metode Baru</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('methods.index') }}" class="btn btn-sm btn-primary">Kembali ke Daftar</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('methods.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Informasi Metode</h6>
                            <div class="pl-lg-4">
