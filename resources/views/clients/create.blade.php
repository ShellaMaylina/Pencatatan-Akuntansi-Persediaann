                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Pendaftaran Klien</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('clients.store') }}" autocomplete="off">
                            @csrf
                            <h6 class="heading-small text-muted mb-4">Informasi Klien</h6>
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-1">
                                        <label class="form-control-label" for="input-document_type">Jenis</label>
                                    ...
                                    <div class="col">
                                        <label class="form-control-label" for="input-document_id">Nomor Dokumen</label>
